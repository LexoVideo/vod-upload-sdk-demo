...
        const url = '/get_sts?key={key}'; // Replace URL with your backend service, get a temporary key callback. 'key' and the interface are provided by Lexo.
...
        os_id: "test-in", // Upload ID tag, assigned by Lexo
        // task_type:
